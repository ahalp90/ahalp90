...
**Featured Project**
[LSTM Market Classifier](https://github.com/ahalp90/lstm-market-classifier) - Time-series inference model and data pipeline. Analytical write-up, Python scraper modules and detailed notebook.
